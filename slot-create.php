<?php 
    ...
    if(isset($_POST['name'])){
        ...
        if(!empty($_POST['name'])){
            ...
            $response = $database->slotStore($_POST);
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" name="name" class="form-control input-md" placeholder="E.g. Morning" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    <label>Start time <small class="text-danger">(required)</small></label>
                                    <input type="time" name="start_time" class="form-control input-md" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    <label>End time <small class="text-danger">(required)</small></label>
                                    <input type="time" name="end_time" class="form-control input-md" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-2">
