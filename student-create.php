<?php 
    ...
    if(isset($_POST['name'])){
        ...
        if(!empty($_POST['name'])){
            ...
            $response = $database->studentStore($_POST);
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" name="name" class="form-control input-md" placeholder="E.g. Mostafijur Rahman" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    <label>Student ID <small class="text-danger">(required)</small></label>
                                    <input type="number" name="student_id" class="form-control input-md" placeholder="E.g. 2019100010027" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    <label>Batch <small class="text-danger">(required)</small></label>
                                    <input type="text" name="batch" class="form-control input-md" placeholder="E.g. 5th" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group my-2">
                                    <label>Department <small class="text-danger">(required)</small></label>
                                    <input type="text" name="department" class="form-control input-md" placeholder="E.g. CSE" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group my-2">
